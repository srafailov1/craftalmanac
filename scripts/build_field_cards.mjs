...
// ---------------------------------------------------------------------------
const CARDS_CSS = `
    :root { --ink:#23301f; --paper:#faf8f0; --green:#1f5c3d; --rule:#d8d2bf; }
    * { box-sizing: border-box; }
    body { margin: 0; padding: 28px 14px 56px; background: var(--paper); color: #111; font-family: Georgia, "Times New Roman", serif; }
    a { color: var(--green); }
    .intro { max-width: 720px; margin: 0 auto 22px; line-height: 1.55; }
    .intro h1 { font-size: 1.5rem; margin: 0 0 0.3em; color: var(--ink); }
    .intro p { margin: 0.5em 0; font-size: 0.95rem; }
    .intro .k { font-family: ui-monospace, SFMono-Regular, Menlo, Consolas, monospace; font-size: 0.72rem; text-transform: uppercase; letter-spacing: 0.07em; color: #6b7256; }
    .sheet-list { list-style: none; padding: 0; margin: 1em 0; }
    .sheet-list li { margin: 0.5em 0; }
    .sheet-list .count { color: #6b7256; font-size: 0.85em; }
    ...
    .qr-cap { font-family: ui-monospace, SFMono-Regular, Menlo, Consolas, monospace; font-size: 4.6pt; color: #555; letter-spacing: 0.02em; }
    .name { font-size: 10.5pt; line-height: 1.12; margin: 0; font-weight: 700; color: #000; }
    .sci { font-size: 7.5pt; font-style: italic; color: #333; margin: 0.4mm 0 1.3mm; }
    .row { font-size: 6.8pt; line-height: 1.35; margin: 0.7mm 0; color: #111; }
    .row b { font-family: ui-monospace, SFMono-Regular, Menlo, Consolas, monospace; font-size: 5.6pt; text-transform: uppercase; letter-spacing: 0.06em; color: #444; font-weight: 700; }
    .row.safety b { color: #7a1e10; }
    .mode-note { font-variant: small-caps; font-size: 6.6pt; letter-spacing: 0.03em; margin: 1mm 0 0; color: #000; }
    .foot { margin-top: 1.4mm; padding-top: 1mm; border-top: 0.3mm solid #b9b9b9; font-family: ui-monospace, SFMono-Regular, Menlo, Consolas, monospace; font-size: 5.4pt; text-transform: uppercase; letter-spacing: 0.04em; color: #333; }
    footer.page-foot { max-width: 720px; margin: 34px auto 0; border-top: 1px solid var(--rule); padding-top: 1em; font-size: 0.85rem; color: #5a6152; line-height: 1.55; }
    @page { margin: 14mm; }
    @media print {
